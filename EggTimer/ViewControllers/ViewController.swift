...
class ViewController: NSViewController {
    ...
    @IBAction func onStartTimerMenuItemSelected(_ sender: Any) {
        
        onStartButtonClick(sender)
    }
    
    @IBAction func onStopTimerMenuItemSelected(_ sender: Any) {
        
        onStopButtonClick(sender)
    }
    
    @IBAction func onResetTimerMenuItemSelected(_ sender: Any) {
        
        onResetButtonClick(sender)
    }
}
